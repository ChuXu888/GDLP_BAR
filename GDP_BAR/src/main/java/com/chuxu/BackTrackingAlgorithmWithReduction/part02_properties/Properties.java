...
public class Properties {
    ...
    //性质5：算法求解过程中，对于距离矩阵中V\V0\VV0=VV5(V)∪V1∪VV1涉及到的【子矩阵】中，如果有任何一个数值dij<b
    //则该数值涉及到的一对点vi和vj不能同时开设。
    public static void property05(LinkedHashSet<Facility> V, LinkedHashSet<Facility> V1, LinkedHashSet<Facility> VV1) {
        //计算V1∪VV1
        LinkedHashSet<Facility> V_Add_V1_Add_VV1 = new LinkedHashSet<>(V);
        V_Add_V1_Add_VV1.addAll(V1);
        V_Add_V1_Add_VV1.addAll(VV1);
        //同时遍历VV5(V)和V1_Add_VV1，寻找dij<b的couple
        for (Facility vi : V_Add_V1_Add_VV1) {
            for (Facility vj : V_Add_V1_Add_VV1) {
